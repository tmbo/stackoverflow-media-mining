...
-- merged tables
UPDATE SO_TAG_SUBSCRIBERS
SET ACTIVE_SUBSCRIBERS = SO_TAG_SUBSCRIBERS_ACTIVE_TEMP.ACTIVE_SUBSCRIBERS
FROM SO_TAG_SUBSCRIBERS, SO_TAG_SUBSCRIBERS_ACTIVE_TEMP
WHERE SO_TAG_SUBSCRIBERS.TAG = SO_TAG_SUBSCRIBERS_ACTIVE_TEMP.TAG;

UPDATE SO_TAG_SUBSCRIBERS
SET RESPONSIVE_SUBSCRIBERS = SO_TAG_SUBSCRIBERS_RESPONSIVE_TEMP.RESPONSIVE_SUBSCRIBERS
FROM SO_TAG_SUBSCRIBERS, SO_TAG_SUBSCRIBERS_RESPONSIVE_TEMP
WHERE SO_TAG_SUBSCRIBERS.TAG = SO_TAG_SUBSCRIBERS_RESPONSIVE_TEMP.TAG;
